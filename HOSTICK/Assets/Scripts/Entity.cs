...
public class Entity : MonoBehaviour
{
    ...
    public static IEnumerator SaveLine(string fileAddress, string getValue1, string getValue2, string getValue3, string getValue4, string getValue5,
    int setValue1, string setValue2, string setValue3, string setValue4, string setValue5)
    {
        WWWForm form = new WWWForm();
        form.AddField(getValue1, setValue1);
        form.AddField(getValue2, setValue2);
    ...
    public static string countVsalue;
    public static int countPointNum;
    public static int countLineNum;
    public static string gettedLineNum;

    public static int temptest;

    public static string[] qq;
    public static IEnumerator getValue(string fileAddress)
    {
        WWWForm form = new WWWForm();
        ...
        using (UnityWebRequest www = UnityWebRequest.Post(fileAddress, form))
        {
            ...
            else
            {
               ...
               // qq = www.downloadHandler.text.Split(',');
                //countLineNum = (qq.Length)+;

                temptest = (Int32.Parse(www.downloadHandler.text)+1);
                Debug.Log(" 라인 받는 것:" + temptest);
              
                //countPointNum = countValue.Length+2;
                //Debug.Log(" 라인 받는 것:" + countValue[0]);
                //gettedLineNum = countValue[0];
                //Debug.Log("포인트 받는 것:" + countPointNum);
            }
        }
    ...
    public static IEnumerator getDATE(string fileAddress)
    {
        WWWForm form = new WWWForm();
        ...
        using (UnityWebRequest www = UnityWebRequest.Post(fileAddress, form))
        {
            ...
            else
            {
                ...
                tt = www.downloadHandler.text.Split(',');
                countPointNum = (tt.Length);
   ...
   string setValue1, string setValue2, string setValue3)
    ...
    public static string[] GLineSequence2; //라인이 몇개인지 받아지는 것
    public static int GcountLineSeq2; //라인이 몇개인지에 대한 것
    ...
    public static IEnumerator GETGPS2(string fileAdrress, string getValue1, string getValue2, string getValue3, string setValue1, string setValue2, string setValue3)
    {
        WWWForm form = new WWWForm();
    ...
    public static string[] colorSizeCnt;
    public static IEnumerator getColorSize(string fileAddress, string getValue1, string setValue1)
    {
        WWWForm form = new WWWForm();
        ...
        using (UnityWebRequest www = UnityWebRequest.Post(fileAddress, form))
        {
            ...
            {
                colorSizeCnt = www.downloadHandler.text.Split(',');
            }
        }
    }

    public static string[] PointNumberArray;
    public static int PointNumberCount;

    public static IEnumerator PointNumCount(string fileAddress)
    {
        WWWForm form = new WWWForm();
        ...
        using (UnityWebRequest www = UnityWebRequest.Post(fileAddress, form))
        {
            ...
            {
                PointNumberArray = www.downloadHandler.text.Split(',');
                PointNumberCount = (PointNumberArray.Length);
                //Debug.Log("Point 수:" + PointNumberCount);
            }
        }
    }
}